...
export class Init1770728360125 implements MigrationInterface {
    name = 'Init1770728360125'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "seat" ("id" character varying NOT NULL, "placement" character varying NOT NULL, "status" "public"."seat_status_enum" NOT NULL DEFAULT 'AVAILABLE', "session_id" character varying, CONSTRAINT "PK_4e72ae40c3fbd7711ccb380ac17" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "reservation" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "expiresAt" TIMESTAMP NOT NULL, "userId" character varying, "seatId" character varying, CONSTRAINT "PK_48b1f9922368359ab88e8bfa525" PRIMARY KEY ("id"))`);
